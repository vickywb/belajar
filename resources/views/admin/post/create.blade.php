                ...
                <div class="box-body">
                  <form role="form" action="{{ route('admin.post.store')  }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group my-2">
                      ...
                      <input value="{{ old('title') }}" type="text" class="form-control" name="title" id="title" placeholder="{{ __('Judul Artikel') }}" required autocomplete="off">  
                    </div>
                    <div class="form-group my-2">
                      <label for="slug">{{ __('Slug') }}</label>
                      <input value="{{ old('slug') }}" type="text" class="form-control" name="slug" id="slug" placeholder="{{ __('Contoh: Artikel-Sekolah') }}" required autocomplete="off">  
                    </div>
                    {{-- <div class="form-group my-2">
                      <label for="exceprt">{{ __('Exceprt') }}</label>
                      <input value="{{ old('exceprt') }}" type="text" class="form-control" name="exceprt" id="exceprt" placeholder="{{ __('Exceprt from Description ') }}" required autocomplete="off">  
                    </div> --}}
                    <div class="form-group my-2">
